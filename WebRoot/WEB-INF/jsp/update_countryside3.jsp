...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="basicInfoControl/update_countryside" method="post">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">人均纯收入 	：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="renjunshouru">
				<div style="height:15px" id="">${renjunShouruError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">农业产值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="nongyechanzhi">
				<div style="height:15px" id="">${nongyeChanzhiError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">村集体收入：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="cunshouru">
				<div style="height:15px" id="">${cunshouruError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">村小学个数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="cunxiaoxue">
				<div style="height:15px" id="">${cunxiaoxueError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">村中学个数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="cunzhongxue">
				<div style="height:15px" id="">${cunzhongxueError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">人口总数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="renkouzongshu">
				<div style="height:15px" id="">${renkouZongshuError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">常住人口数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="changzhurenkoushu">
				<div style="height:15px" id="">${changzhuRenkouError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">户籍人口数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="hujirenkoushu">
				<div style="height:15px" id="">${hujiRenkoushuError}</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">农业人口数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="nongyerenkoushu">
				<div style="height:15px" id="">${nongyeRenkoushuError}</div>
			</div>
		</div>
