...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="IDemocraticManage/insert_tianjiaminshi" onsubmit="return check()">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="帐号不能为空" id="account" name="account">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="最长可输入255个字" id="reason" name="reason">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text Wdate" readonly="readonly" id="biangengshijian" name="biangengshijian"/>
