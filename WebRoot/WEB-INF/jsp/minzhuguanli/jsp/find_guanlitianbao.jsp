...
<div class="page-container">
	<div class="mt-20">
	<form action="IDemocraticManage/find_guanlitianbao">
	<div class="text-c">
...
<i class="Hui-iconfont">&#xe6df;</i></a>
		...
		<a href="IDemocraticManage/find_guanlitianbao?thispage=${idme.get(0).firstpage}&biangeng=${biangeng}">首页</a>
		<a href="IDemocraticManage/find_guanlitianbao?thispage=${idme.get(0).prepage}&biangeng=${biangeng}">上一页</a>
		<a href="IDemocraticManage/find_guanlitianbao?thispage=${idme.get(0).nextpage}&biangeng=${biangeng}">下一页</a>
		<a href="IDemocraticManage/find_guanlitianbao?thispage=${idme.get(0).lastpage}&biangeng=${biangeng}">尾页</a>
		</c:if>
	</div>
</div>
