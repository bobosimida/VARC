...
<div class="page-container">
	<form action="workAndMessageControl/send_email" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>收件人帐号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${receiveAccount}" placeholder="" id="" name="receiveAccount">
