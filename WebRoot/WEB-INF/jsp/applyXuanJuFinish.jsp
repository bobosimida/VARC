...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" method="post" action="democraticElectionControl/applyXuanJuFinish_updateState" onsubmit="return check()">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select   class="select" name="shenqingzhuangtai">
					<option value="3">申请民主选举结束</option>
				</select>
				</span>
			</div>
		</div>
		<input type="hidden" name = "id" value="${minZhuXuanJu.id}">
			<div class="row cl">
